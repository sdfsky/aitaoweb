...
$lang = array(
	...
	'tips_admininfo_comment' => '请牢记Tipask问答系统创始人密码，凭该密码登陆 ask。',
	'step_ext_info_title' => '安装成功',
	'step_ext_info_desc' => '点击进入登陆',

	'ext_info_succ' => '安装成功',
	'install_locked' => '安装锁定，已经安装过了，如果您确定要重新安装，请到服务器上删除<br /> '.str_replace(TIPASK_ROOT, '', $lockfile),
	'error_quit_msg' => '您必须解决以上问题，安装才可以继续',

	'step_app_reg_title' => '设置运行环境',
	'step_app_reg_desc' => '检测服务器环境以及设置 ask',
	'tips_ask' => '请填写Tipask问答系统相关信息',
	'tips_ask_comment' => 'ask 是 Comsenz 公司产品的核心服务程序，Discuz! Board 的安装和运行依赖此程序。如果您已经安装了 ask，请填写以下信息。否则，请到 <a href="http://www.tipask.com/" target="blank">Comsenz 产品中心</a> 下载并且安装，然后再继续。',
	...
	'uc_url_empty' => '您没有填写Tipask问答系统的 URL，请返回填写',
	...
	'uc_version_incorrect' => '您的Tipask问答系统服务端版本过低，请升级Tipask问答系统服务端到最新版本，并且升级，下载地址：http://www.tipask.com/ 。',
	'config_unwriteable' => '安装向导无法写入配置文件, 请设置 config.inc.php 程序属性为可写状态(777)',

	'install_in_processed' => '正在安装...',
	'install_succeed' => '安装Tipask成功，点击进入下一步',
	'license' => '<div class="license"><h1>中文版授权协议 适用于中文用户</h1>

<p>版权所有 (c) 2001-2012，Tipask软件开发工作室保留所有权利。</p>

<p>感谢您选择Tipask问答产品。希望我们的努力能为您提供一个高效快速和强大的站点解决方案。</p>

<p>Tipask软件开发工作室为Tipask问答产品的开发商，依法独立拥有Tipask问答系统著作权。Tipask软件开发工作室网址为 http://www.tipask.com。</p>
...
<p>本授权协议适用且仅适用于Tipask2.X版本，Tipask软件开发工作室拥有对本授权协议的最终解释权。</p>
...
<h3>II. 协议规定的约束和限制</h3>
<ol>
<li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.tipask.com参考相关说明，也可以致电8610-51657885了解详情。</li>
...
<li>Tipask软件开发工作室不对使用本软件构建的网站中的文章或信息承担责任。</li>
</ol>

<p>有关Tipask问答系统最终用户授权协议、商业授权与技术服务的详细内容，均由Tipask问答系统官方网站独家提供。Tipask软件开发工作室拥有在不事先通知的情况下，修改授权协议和服务价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>
